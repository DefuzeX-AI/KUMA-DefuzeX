...
from ..operations import PendingOperationStore, await_operation, request_identity
from ..privacy import enforce_sensitive_policy, scan_sensitive_json
from ..repo_meta import prepare_repo_meta_upload
...
def _case_operation_store(
    ...
    *,
    ...
    return PendingOperationStore(
        context.repo_path / ".defuzex" / "operations" / "cases" / f"{identity}.json",
